...
while ($row=mysqli_fetch_array($result))
{
    ...
    if($datenow >= $duedate){
        ...
        else
        {
            ...
            $message="Congratulation Mr.".$bname.", Your are the final and highest modelBidder of  Product ".$ProductName.". Now This is Your Product. Product Seller is ".$sname.", You can contact with Seller by Email:".$semail." or You can use phone: ".$sphone.".";
            ...
            <table>
                ...
                while ($row=mysqli_fetch_array($Result)) {
                    ...
                    if($sdate<=$datenow){
                        ...
                        ?>
                        <a href="javascript:bid(<?php echo $row[0]; ?>)"> <img src="Image/bidnow.png"  width="50px" height="50px"  alt="Bid" />
                            <span style="color: green;font-size: 20px"><b>Running</b></span> </a>
                        <?php
                        $break++;
                        echo "<hr>";
