<div class="panel panel-default">
                <div class="panel-body">
                        ...
                        <a class="btn btn-success btn-sm" href="sales/create/"> <span class="fa fa-plus"></span> {lang('new_record')}</a>
                          ...
                          enctype="form-data">
                            <tr class="{cycle values='odd,even'}">
                                ...
                                <td  class="text-capitalize"> 
                                 <input type="hidden" name="sale_itm_id" value="{$row.sale_itm_id}">
                                <input type="hidden" name="sale_imp_id" value="{$row.imp_id}">
                                <input type="hidden" name="imp_itm_available" value="{$row.imp_available_amount}">
                                <input type="hidden" name="imp_itm_sold_amount" value="{$row.imp_sold_amount}">
                                <input type="hidden" name="imp_itm_total_imported" value="{$row.imp_item_amount}">


                           <!--price of product when imported-->                                
                            <input type="hidden" name="imp_itm_unit_price" value="{$row.imp_sale_itm_unit_price}">
                                ...
                                <td>
                                <input class="input-sm" type="number" name="sell_quantity" min="1"  max="{$row.imp_available_amount}" required/>
                                 </td>
                                 <td>
                                 ...
                                 <td>
                                    <button class="btn btn-sm btn-success" type="submit">{lang('save_sell')}</button>
                                 </td>
                            </tr>
                            </form>
                        {/foreach}
                 ...
                 {/if}
                        ...
                        <!-- <div class="col-lg-12">
                                ...
                                <form class="form" method='post' action='sales/{$action_mode}/{if isset($record_id)}{$record_id}{/if}' enctype="multipart/form-data">
