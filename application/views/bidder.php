...
<head>
    ...
    <div class="container">
        <div class="col-lg-2">
            <label class="text-capitalize">bid end date</label>
            <?php echo $post['biding_end_date']?>
        </div>
        <img src="uploads/<?php echo $post['Document_image'] ?>" width="300" height="300">
<tr> <td><?php echo anchor('winner/','If you want to bid this product',['class'=>'btn btn-primary btn-md']);?>
    </td>
    <td>
    </td>
</tr>
        <?php echo anchor("bidder/view/{$post['Document_id']}",'read more',['class'=>'btn btn-primary btn-md']);?>
