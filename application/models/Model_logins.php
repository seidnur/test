...
class Model_logins extends CI_Model 
{
    function __construct()
    {
		 ...
		 *     - TRUE:  just the field names of the logins table
	...
	function get ( $id, $get_one = false )
	{
	    ...
	    $select_statement = ( $this->raw_data ) ? 'login_id,Ip_address,browser,LoginDate' : 'login_id,Ip_address,browser,LoginDate';
	...
	function lister ( $page = FALSE )
	{
	    ...
	    $this->db->start_cache();
		$this->db->select( 'login_id,Ip_address,browser,LoginDate');
		$this->db->from( 'logins' );
	...
	function search ( $keyword, $page = FALSE )
	{
        ...
        die('Please see models/model_logins.php for setting up the search method.');
        ...
        if( $this->pagination_enabled == TRUE )
        {
            $config = array();
            $config['total_rows']  = $this->db->count_all_results();
            $config['base_url']    = '/logins/search/'.$keyword.'/';
    ...
    {
        $fs = array(
	'login_id' => lang('login_id'),
	'Ip_address' => lang('Ip_address'),
	'browser' => lang('browser'),
	'LoginDate' => lang('LoginDate')
);
    ...
    function metadata()
    {
        ...
        $metadata = $this->explain_table->parse( 'logins' );
